...
function TableComponent() {
    ...
    const cancelledRoutes = state.booking.routeData.filter(route => route.status === "Cancelled");
    ...
    if (cancelledRoutes.length === 0) {
        return (
            <Empty>
                ...
                <Empty.Title className="text-2xl font-semibold">Looks empty, you've no cancelled bookings.</Empty.Title>
